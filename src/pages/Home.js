          ...
          <div className="col-6">
            <div className="main-banner position-relative">
              ...
              <div className="main-banner-content position-absolute">
                ...
                <h5>iPad s13+ Pro.</h5>
                <p>From 160000LKR or 200000LKR</p>
            ...
            <div className="d-flex flex-wrap gap-10 justify-content-between align-items-center">
              <div className="small-banner position-relative">
                ...
                <div className="small-banner-content position-absolute">
                  ...
                  <h5>iPad s13+ Pro.</h5>
                  <p>
                    From 160000LKR <br /> or 200000LKR
                  </p>
                </div>
              </div>
              <div className="small-banner position-relative">
            ...
            <div className="famous-card position-relative">
              ...
              <div className="famous-content position-absolute">
                ...
                <p className="text-dark">
                  Now in Green. From 100000LKR or 200000LKR. for 24 mo. Footnite
                </p>
              </div>
            </div>
          </div>
          <div className="col-3">
            <div className="famous-card position-relative">
              ...
              <div className="famous-content position-absolute">
                ...
                <p className="text-dark">
                  From 2000LKR or 10000LKR for 12 mo.{" "}
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="col-3">
              <div className="famous-card position-relative">
                ...
                <div className="famous-content position-absolute">
                  ...
                  <h6 className="text-dark">Smart Phone 13 Pro.</h6>
                  <p className="text-dark">
                    Now in Green. From 100000LKR or 200000LKR. for 24 mo.
                    Footnite
                  </p>
                </div>
              </div>
